...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.do_not_disturb.DoNotDisturbPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin do_not_disturb, com.example.do_not_disturb.DoNotDisturbPlugin", e);
    }
    try {
